...
export const translations = {
    "TR": {
        ...
        "start": "Başla",
        "next": "İleri",
        "change_it_later": "Daha sonra ayarlardan da değiştirebilirsin",
        ...
        "no_response":"bu konu hakkında bilgim yok 😞",
        "alerts": {
            "analysis_in_progress": "Devam eden bir analiziniz var, lütfen biraz bekleyin",
            "incorrect_format": "Tarih formatı hatalı görünüyor. lütfen kontrol edin👆",
            "supports_two": "Synto, şu an için sadece 2 kişi arasındaki konuşmaları destekler.",
            "valid_file": "Lütfen geçerli bir dosya giriniz",
            "failed_file": "Dosya Seçilemedi",
        },
    ...
    "EN": {
        ...
        "start": "Start",
        "next": "Next",
        "change_it_later": "You can change it later from settings",
        ...
        "no_response":"I have no knowledge about this subject 😞",
        "alerts": {
            "analysis_in_progress": "You have analysis in progress, please wait a moment",
            "incorrect_format": "The date format seems to be incorrect. please check👆",
            "supports_two": "Synto currently only supports conversations between 2 people.",
            "valid_file": "Please enter a valid file",
            "failed_file": "Failed to Select File",
        },
